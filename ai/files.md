...
| File | Description |
|------|-------------|
| `anaf.js` | ANAF API core module - exports getCompanyFromANAF(cif), searchCompany(brandName), with cuiscan.ro fallback |
...
| `tests/unit/demoanaf.test.js` | Unit tests for ANAF/CUIScan company data retrieval with mocked responses |
